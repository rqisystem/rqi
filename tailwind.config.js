...
export default {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      'soft-gray': '13px 13px 20px #cbced1, -13px -13px 20px #ffffff',
      'dark-gray': '13px 13px 20px #2C3856, -13px -13px 20px #000000',
      form: 'box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;',
      profil:
        '0px 0px 2px #5f5f5f,0px 0px 0px 5px #ecf0f3,8px 8px 15px #a7aaaf,-8px -8px 15px #ffffff',
      'profil-dark':
        '0px 0px 2px #5f5f5f,0px 0px 0px 5px #2C3856,8px 8px 15px #2C3856,-8px -8px 15px #000000',
      input: 'inset 8px 8px 8px #cbced1,inset -8px -8px 8px #ffffff',
      'input-dark': 'inset 8px 8px 8px #2C3856,inset -8px -8px 8px #000000',
      button: '3px 3px 8px #b1b1b1,-3px -3px 8px #ffffff',
      'button-dark': '3px 3px 8px #2C3856,-3px -3px 8px #000000',
